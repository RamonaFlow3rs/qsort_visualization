...
final class VisualSortArray extends AbstractSortArray {
	...
	public VisualSortArray(int scale, double speed, int [] values){
	...
	private static Color[] STATE_COLORS = {
			new Color(Color.DARK_GRAY.getRGB()),  // Active: Blue 0x999CC
			new Color(Color.LIGHT_GRAY.getRGB()),  // Inactive: Gray 0xCCCFF
			new Color(0x999CC),  // Comparing: Yellow
			new Color(0x000099),  // Done: Green
	};

	private static Color BACKGROUND_COLOR = new Color(Color.WHITE.getRGB());  // White
